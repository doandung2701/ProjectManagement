...
export class TaskDetailComponent implements OnInit {
    ...
    updateCommon() {
        ...
        if (new Date(this.taskDetail.startTime.getFullYear(),this.taskDetail.startTime.getMonth()-1,this.taskDetail.startTime.getDate()) <
        new Date(this.taskDetail.createdTime.getFullYear(),this.taskDetail.createdTime.getMonth()-1,this.taskDetail.createdTime.getDate())
        ) {
            this.notificationService.showNotification(MessageType.ERROR, "Task start Time can not less than created time");
            return;
        }
        if (new Date(this.taskDetail.deadline.getFullYear(),this.taskDetail.deadline.getMonth()-1,this.taskDetail.deadline.getDate()) <
        new Date(this.taskDetail.createdTime.getFullYear(),this.taskDetail.createdTime.getMonth()-1,this.taskDetail.createdTime.getDate())
        )
         {
